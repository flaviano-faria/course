...
public class CourseUserController {
    ...
    public ResponseEntity<Page<UserRecordDto>> getAllUsersByCourse(@PageableDefault(sort = "userId",
    ...
    public ResponseEntity<Object> saveSubscriptionInCourse(@PathVariable(value="courseId") UUID courseId,
        ...
        if(
                courseUserService.existsByCourseAndUserId(courseModelOptional.get(),
        ...
        CourseUserModel courseUserModel = courseUserService.saveAndSendSubscriptionUserInCourse(
                courseModelOptional.get().convertToUserModel(subscriptionRecordDto.userId()));
